...
<head>
    <meta charset="UTF-8">
    <title>Kütüphane Sistemi - Ana Sayfa</title>
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10 content">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h1>Hoş Geldiniz, <%= kullanici.getUyeAd() %></h1>
                ...
                <h3 class="mb-3">Son Eklenen Kitaplar</h3>
                ...
                <div class="text-center mt-4">
                    <a href="kitaplar" class="btn btn-primary">
                        <i class="fas fa-book me-2"></i>Tüm Kitapları Görüntüle
                    </a>
                </div>
            </div>
        </div>
